...
fn test_against_evalexpr_float(expr: &str, input: f32) {
    ...
    assert_eq!(func.execute(input), expected as f32);
}
...
fn test_unary_examples() {
    ...
    test_against_evalexpr_float("3.3", 0.0);
    ...
    test_against_evalexpr_float("-3.6", 0.0);

    // assert_eq!(eval("----3.0"), Ok(Value::Int(3)));
    test_against_evalexpr_float("----3.0", 0.0);
